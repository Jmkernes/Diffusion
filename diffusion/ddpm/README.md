...
$$
\frac{dx}{dt} + \nabla V = \eta(t), \;\;\; p(\eta) \sim e^{-\eta^2 / 4D}
$$
...
$$
x_t = x_{t-1} + \epsilon  \nabla_x  \ln q_\theta(x) + \sqrt{2\epsilon} z, \;\;\; z \sim N(0, 1)
$$
